...
def create_batch_job(input_file_id):
    ...
    batch = client.batches.create(input_file_id=input_file_id, endpoint="/v1/chat/completions", completion_window="168h")
...
def main():
    # 文件路径
    input_file_path = "data/train_some_msg2.jsonl"  # 可替换为您的输入文件路径
    output_file_path = "data/train_some_llm2.jsonl"  # 可替换为您的输出文件路径
    error_file_path = "data/train_some_error2.jsonl"  # 可替换为您的错误文件路径
    try:
